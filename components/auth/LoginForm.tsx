    ...
    <div className="flex min-h-screen flex-col bg-[#FDFBF7]">
      ...
      <div className="flex-1 px-6 py-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Input
              ...
              icon={
                <button
                  ...
                  className="text-[#4A3B32] hover:text-[#3D2C22]"
                >
                  {showPassword ? (
          ...
          <Link href="#" className="text-right text-sm text-[#C5A059] hover:text-[#B8860B]">
            Esqueci minha senha
          </Link>
        ...
        <div className="my-6 flex items-center gap-3">
          <div className="flex-1 border-t border-[#F5F2ED]" />
          <span className="text-sm text-[#4A3B32]">ou acesse com</span>
          <div className="flex-1 border-t border-[#F5F2ED]" />
        </div>

        <div className="flex justify-center gap-6">
          <button className="flex h-12 w-12 items-center justify-center rounded-full border border-[#F5F2ED] text-[#D4AF37] hover:bg-[#FAF8F5]">
        ...
        <p className="mt-6 text-center text-sm text-[#4A3B32]">
          ...
          <Link href="/auth/signup" className="font-semibold text-[#C5A059] hover:text-[#B8860B]">
            Cadastre-se aqui!
          </Link>
        </p>
      </div>
